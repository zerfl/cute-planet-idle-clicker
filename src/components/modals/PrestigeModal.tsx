...
export const PrestigeModal: React.FC<PrestigeModalProps> = ({
  ...
  const currentMultiplier = 1 + prestigeCount * 0.10;
      ...
      >
        ...
        <div className="p-4 sm:p-6 overflow-y-auto max-h-[70vh] space-y-5">
          ...
          <div className="space-y-2.5">
            <h6 className={`font-sans font-black text-[10px] uppercase tracking-wider font-mono ${isNight ? "text-purple-300" : "text-amber-700"}`}>
            ...
            <div className={`p-3.5 rounded-2xl border text-xs leading-relaxed space-y-2 font-semibold ${
              ...
              <div className="flex gap-2">
                ...
                <p>
                  Ein Prestige setzt dein aktuelles <strong className="text-pink-400">Leben, LPS, Tiere, Sterne</strong> und <strong className="text-pink-400">Planeten-Level</strong> zurück.
                </p>
              </div>
              <div className="flex gap-2">
                ...
                <p>
                  ...
                  <strong className="text-green-400"> +10% Lebensenergie-Produktion </strong> (aktive Klicks & LPS).
                </p>
              </div>
              <div className="flex gap-2">
                <span className="text-sky-400">✦</span>
                <p>
                  Außerdem erhältst du bei jedem Aufstieg <strong className="text-sky-400">1x Sternschnuppen-Lootbox 🌠</strong>, die du im Inventar für neue Kosmetika öffnen kannst.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className={`p-4 border-t-2 flex flex-col gap-2 transition-colors duration-500 shrink-0 ${
          ...
          {canPrestige ? (
            ...
            >
              <Sparkles className="w-4 h-4 text-amber-100 animate-spin" style={{ animationDuration: "4s" }} />
