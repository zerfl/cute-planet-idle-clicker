...
import { getZodiac } from "../../data/zodiacs";
    ...
    return (
      ...
      >
        ...
        <div className="flex flex-col items-center text-center">
          <div
            className={`p-1.5 rounded-full bg-linear-to-tr ${isNight ? "from-purple-800 to-indigo-950" : "from-amber-100 to-yellow-50"} mb-4`}
          >
          ...
          >
            ...
            <div className="flex items-center gap-1.5 font-sans font-black text-xs">
              <Sparkles
                className={`size-4  ${isNight ? "text-cosmic-accent animate-pulse" : "text-amber-600"}`}
              />
          ...
          <button
            ...
            className={`w-full py-3 rounded-2xl text-xs font-black uppercase tracking-wider transition-all active:scale-98 cursor-pointer shadow-lg hover:shadow-xl ${
              isNight
                ? "bg-linear-to-r from-purple-550 to-indigo-600 hover:from-purple-650 hover:to-indigo-700 text-white border-2 border-purple-400/40"
