      ...
      >
        ...
        <div className="p-4 sm:p-5 border-b-3 border-fuchsia-400/50 bg-gradient-to-r from-[#171430] via-[#241744] to-[#171430] flex items-center justify-between shrink-0">
          <div className="flex items-center gap-3">
            ...
            <div>
              <span className="text-[10px] uppercase font-black tracking-widest text-fuchsia-300 block">
                Dunkle Materie Labor
              </span>
              <h4
                id="shard_shop_title"
        ...
        <div className="bg-[#120a28] border-b border-fuchsia-500/20 p-4 shrink-0 flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <p className="text-[10px] sm:text-xs leading-relaxed max-w-xs text-fuchsia-200/80 font-medium text-center sm:text-right">
            Sammle Galaxie-Splitter, indem du mit deinem Planeten{" "}
            <span className="text-amber-350 font-bold">Stufe 20</span> erreichst und einen{" "}
            <span className="text-fuchsia-300 font-bold">Aufstieg (Prestige)</span> vollziehst!
          </p>
        </div>
                  ...
                  >
                    <div>
                      <div className="flex items-center justify-between mb-2">
                        ...
                        {isMaxLevel ? (
                          <span className="text-[8.5px] font-black uppercase text-emerald-400 tracking-wider">
                            MAX Stufe
                          </span>
                        ) : (
                    ...
                    >
                      {isMaxLevel
                        ? "Maximiert!"
                        : hasEnough
                          ? `Upgrade auf Stufe ${lvl + 1}`
                          : "Nicht genug Splitter"}
                    </button>
                  </div>
                );
              })}
              ...
              >
                ...
                <div className="flex flex-col items-end gap-2 shrink-0 self-stretch sm:self-center justify-center">
                  <div className="flex items-center gap-1 font-mono text-xs font-black text-[#f5d0fe] bg-[#120a28] px-3 py-1 rounded-xl border border-fuchsia-500/15">
                    ...
                    <span
                      className={
                        galaxyShards >= slummerGlassLevel ? "text-fuchsia-300" : "text-rose-400"
                      }
                    >
                      {slummerGlassLevel} 🌌
                    </span>
              ...
              >
                ...
                <div className="flex flex-col items-end gap-2 shrink-0 self-stretch sm:self-center justify-center">
                  <div className="flex items-center gap-1 font-mono text-xs font-black text-[#f5d0fe] bg-[#120a28] px-3 py-1 rounded-xl border border-fuchsia-500/15">
                    ...
                    <span
                      className={
                        galaxyShards >= catalystLevel + 1 ? "text-fuchsia-300" : "text-rose-400"
                      }
                    >
                      {catalystLevel + 1} 🌌
                    </span>
              ...
              >
                <div className="flex items-center gap-3.5 self-start">
                  ...
                  <div>
                    ...
                    <p className="text-[10px] sm:text-xs text-fuchsia-100/75 mt-1 leading-relaxed max-w-sm">
                      Gibt dir eine permanente{" "}
                      <span className="text-pink-300 font-extrabold">+10% Chance</span> pro Stufe
                      auf{" "}
                      <span className="text-fuchsia-300 font-black">
                        verdoppelten Sternengewinn
                      </span>{" "}
                      und <span className="text-fuchsia-200 font-black">verdoppelte Ausbeute</span>{" "}
                      von kosmischem Glitzerstaub!
                    </p>
                    <div className="flex items-center gap-3 mt-2.5">
                      ...
                      <span className="text-[10px] font-semibold text-pink-300">
                        ...
                        <span className="font-extrabold">
                          {(doubleStellarLevel + 1) * 10}% Chance
                        </span>
                      </span>
                    </div>
                  </div>
