...
export const ZODIACS: ZodiacSpec[] = [
  ...
  },
  {
    ...
    name: "Mond",
    emoji: "🌙",
    description: "Mond-Sturm: Erhöht deine maximale Anzahl an Monden um +1 und verstärkt den Produktionsbonus um +50% absoluten Multiplikator pro Mond.",
  ...
  },
  {
    ...
    name: "Drache",
    emoji: "🐉",
    description: "Events stärker: Alle kosmischen Event-Boni (Meteor, Aurora, Supernova) sind um +40% stärker.",
  ...
  },
  {
    ...
    name: "Eule",
    emoji: "🦉",
    description: "Nächtliche Weisheit: Erhöht die Energie-Produktion deiner Sterne um +30% mehr LPS.",
