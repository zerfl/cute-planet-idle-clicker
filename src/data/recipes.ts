...
export const CRAFTING_RECIPES: Recipe[] = [
  // ==================== MATERIALS (ROH- & ZWISCHENPRODUKTE) ====================
  {
    ...
    result: {
      ...
      name: "Sternenstaub",
      emoji: "✨",
      description: "Feiner, glitzernder kosmischer Staub. Grundzutat für fast alles.",
      quantity: 1,
    },
  },
  {
  ...
  },
  {
    ...
    result: {
      ...
      emoji: "☄️",
      description: "Ein heißer, glühender Metallsplitter mit magnetischen Eigenschaften.",
      quantity: 1,
    },
  },
  {
    ...
    result: {
      ...
      emoji: "🌌",
      description: "Ein fluidisierter Lichtpartikel, der in grün-violetten Farben schimmert.",
      quantity: 1,
    },
  },
  {
  ...
  },
  {
    ...
    result: {
      ...
      name: "Nebelgas",
      emoji: "☁️",
      description: "Dichtes kosmisches Nebelgas, das weich glüht und Energien speichert.",
      quantity: 2,
    },
  },
  {
    ...
    result: {
      ...
      name: "Dunkle Materie",
      emoji: "🌑",
      description: "Schwere, unsichtbare Substanz, die Licht krümmt.",
      quantity: 1,
    },
  },
  {
  ...
  },
  {
    ...
    result: {
      ...
      name: "Astrale Saat",
      emoji: "🌾",
      description: "Ein glühender Samen, aus dem reichhaltiges Leben sprießen kann.",
      quantity: 1,
    },
  },
  {
    ...
    result: {
      ...
      emoji: "🧪",
      description: "Kristallklare Flüssigkeit, die pure Astralkraft verströmt.",
      quantity: 1,
    },
  },
  {
  ...
  },
  {
    ...
    result: {
      ...
      name: "Astral-Magnet",
      emoji: "🧲",
      description: "Zieht herabstürzende kosmische Gesteine mühelos an.",
      quantity: 1,
    },
  },
  {
    ...
    result: {
      ...
      name: "Warp-Scherbe",
      emoji: "🔮",
      description: "Bricht das Raum-Zeit-Gefüge in winzigen Clustern.",
      quantity: 1,
    },
  },
  {
    ...
    result: {
      ...
      emoji: "🔥",
      description: "Flüssiges Plasma, das extreme Hitze erzeugt.",
      quantity: 2,
    },
  },
  {
    ...
    result: {
      ...
      emoji: "⚡",
      description: "Ein Stab, der Milliarden Volt kosmisches Plasma bündeln kann.",
      quantity: 1,
    },
  },
  {
    ...
    result: {
      ...
      emoji: "❄️",
      description: "Feiner, tiefgekühlter Staub, der einen hellen Streifen hinterlässt.",
      quantity: 1,
    },
  },
  {
    ...
    result: {
      ...
      emoji: "🏺",
      description: "Ein gläsernes Relikt, das ein Gefühl von Tiefschlaf vermittelt.",
      quantity: 1,
    },
  },
  {
    ...
    result: {
      ...
      emoji: "🫧",
      description: "Sehr leichtes, violett schäumendes Material.",
      quantity: 3,
    },
  },
  {
    ...
    result: {
      ...
      name: "Schwere-Anker",
      emoji: "⚓",
      description: "Bietet unerschütterliche Standfestigkeit im Raum-Zeit-Fluss.",
      quantity: 1,
    },
  },
  {
  ...
  },
  {
    ...
    result: {
      ...
      name: "Deko-Schatulle",
      emoji: "📦",
      description: "Schaltet ein zufälliges kosmetisches Item frei (oder gibt +35 Glitzerstaub).",
      quantity: 1,
    },
  },
  {
  ...
  },
  {
    ...
    result: {
      ...
      name: "Goldene Sternschnuppe",
      emoji: "💫",
      description: "Aktivierung lässt +15 Lootboxen & +200 Glitzerstaub herabregnen!",
      quantity: 1,
    },
  },
  {
    ...
    result: {
      ...
      emoji: "🌟",
      description: "Löst sofort das kosmische Event 'Energetischer Helio-Sturm' am Himmel aus!",
      quantity: 1,
    },
  },
  {
    ...
    result: {
      ...
      emoji: "☁️",
      description: "Löst sofort das kosmische Event 'Interstellare Nebelwolke' am Himmel aus!",
      quantity: 1,
    },
  },
  {
    ...
    result: {
      ...
      emoji: "☄️",
      description: "Löst sofort das kosmische Event 'Eisiger Kometenschweif' am Himmel aus!",
      quantity: 1,
    },
  },
  {
    ...
    result: {
      id: "use_trig_stars",
      name: "Sternenwiege-Zünder (Event)",
      emoji: "🍼",
      description: "Löst sofort das kosmische Event 'Kosmische Sternenwiege' am Himmel aus!",
      quantity: 1,
    },
  },
  {
    ...
    result: {
      ...
      emoji: "🕳️",
      description: "Beschwört sofort das riskante 'Schwarze Loch' zum Gamblen!",
      quantity: 1,
    },
  },
  {
  ...
  },
  {
    ...
    result: {
      ...
      name: "Prestige-Phönix-Amulett",
      emoji: "👑",
      description: "Aktivierung gewährt dir sofort +1 Prestige ohne Ressourcenverlust!",
      quantity: 1,
    },
  },
  {
  ...
  },
  {
    ...
    result: {
      id: "use_peach_bless",
      name: "Kirschblüten-Segen",
      emoji: "🌸",
      description: "Aktivierung gewährt dir +5.000.000 Leben und +15 Sterne gratis!",
      quantity: 1,
    },
  },
  {
  ...
  },
  {
    ...
    result: {
      ...
      name: "Glitzer-Quell",
      emoji: "⛲",
      description: "Füllt dein Glitzerstaub-Konto sofort um +85 Glitzerstaub ✨ auf!",
      quantity: 1,
    },
  },
  {
  ...
  },
  {
    ...
    result: {
      ...
      name: "Solar-Eruptions-Box",
      emoji: "📦",
      description: "Gewährt dir +30.000.000 Leben und +4 Lootboxen!",
      quantity: 1,
    },
  },
  {
  ...
  },
  {
    ...
    result: {
      ...
      name: "Tempus-Segen",
      emoji: "⏳",
      description: "Schüttet sofort den Ertrag von 2 Stunden Offline-Ruhe aus (LPS x 7200)!",
      quantity: 1,
    },
  },
  {
    ...
    result: {
      ...
      emoji: "🧿",
      description: "Schaltet ein zufälliges Episches oder Legendäres Kosmetikteil frei!",
      quantity: 1,
    },
  },
  {
    ...
    result: {
      ...
      name: "Sternenlicht-Elixier",
      emoji: "🍹",
      description: "Gewährt dir sofort +1.000.000 Leben und +5 Sterne!",
      quantity: 1,
    },
  },
  {
    ...
    result: {
      ...
      name: "Mondstaub-Säckchen",
      emoji: "💰",
      description: "Öffnen bringt dir +30.000 Leben und +15 Glitzerstaub!",
      quantity: 1,
    },
  },
  {
  ...
  },
  {
    ...
    result: {
      ...
      emoji: "⏱️",
      description: "Führt einen kleinen Zeitsprung aus: Erhalte +5 Stunden LPS-Ertrag direkt!",
      quantity: 1,
    },
  },
];
